...
<body class="text-center"  style="color: #6f42c1">
    <form class="login_form" action="login.php" method="post">
        <h2 class="text-danger" ><?php echo @$_GET['not_admin']?></h2>
        <h2 class="text1" style="color: #6f42c1"><?php echo @$_GET['logged_out']?></h2>
        <center><img src="http://gvnpc.com/admin/images/login_icon.png">
            <h3> <div class="m-3" style="color: #6f42c1" >Admin Login  </div></h3></center>
        ...
        <input class="btn btn-lg btn-primary mt-3" type="submit" name="login" value="Sign in" style="background-color: #7036b3">
    </form>
