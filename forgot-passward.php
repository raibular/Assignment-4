...
<div class="cn-nav">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#"><h5>EBAY</h5></a>
        ...
        <div class="container">
            <div class="lost-pass">
                <div class="lost-pass text-center">
                    <br><br><br><strong>Lost Passward?</strong>
                </div>
                <div class="enterDetail text-center mt-3">
                    For recovery please enter the detail below!
                </div>
                <form>
                    <div class="enterName offset-2 offset-sm-4 mt-3">
                        <p>E-mail/contact#</p>
                        <input type="text"  placeholder="haider@gmail.com">
                    </div>
                    <div class="submit offset-2 offset-sm-4 mt-3">
                        <a href="next-forget.php"><input type="button" value="Submit"></a>
                    </div>
                </form>
            </div>
            <div class="footer">
...
<footer class="cn-ftr">
    <div class="container">
        ...
        <div class="row foter-des">
            ...
            <div class="col-md-3">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScOMajpJHMRSvXy_NQfKOlbmOEvZb9uub6-nXb25toIPJ24sRU-g">
